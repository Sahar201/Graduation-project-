...
/** Inline SVG social icons (no icon font needed, so they always render). */
const ICONS = {
  instagram:
...
const SOCIALS = [
  ...
  { key: 'email', label: 'Email', href: 'mailto:hello@youmatter.app' },
];
...
/**
 * Site footer: brand + social, navigation, a crisis note, and a legal bar.
 */
const Footer = () => {
      ...
      <div className={`container ${styles.inner}`}>
        <div className={styles.brandCol}>
          ...
          <p className={styles.tagline}>
            Your digital sanctuary for mental well-being — tools and support to
            help you find calm and navigate life with resilience.
          </p>
